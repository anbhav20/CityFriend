        ...
        >
          ...
          >
            ...
            <div className="flex mt-6 justify-center items-center gap-5">
              ...
              >
                <img className="h-5 w-5" src="/instagram.png" alt="Instagram" />
              </a>
              ...
              <a
                ...
                aria-label="Email"
              >
                <img className="h-5 w-5" src="/gmail.png" alt="Email" />
              </a>
          ...
          >
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              ...
              <li>
                <Link to="/about" className="hover:text-blue-600 transition">Community</Link>
              </li>
              <li>
                <Link to="/signup" className="hover:text-blue-600 transition">Join</Link>
              </li>
            </ul>
          </div>
